...
app.get('/recipes/complexSearch', (req, res) => {
    ...
    if (req.query.includeIngredients) queryParams.includeIngredients = req.query.includeIngredients;
    if (req.query.excludeIngredients) queryParams.excludeIngredients = req.query.excludeIngredients;
    ...
    const apiUrl = `https://api.spoonacular.com/recipes/complexSearch?` + queryString;
...
app.get('/ingredients/id', (req, res) => {
    ...
    const apiUrl = `https://api.spoonacular.com/recipes/${recipeId}/ingredientWidget.json` + `?apiKey=${apiKey}`;
...
app.post('/favorites', (req, res) => {
    ...
    const existingFavorite = favorites.find(favorite => favorite.recipeId === newFavorite.recipeId);
